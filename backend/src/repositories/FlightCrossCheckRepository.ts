...
export class FlightCrossCheckRepository {
    /**
     * Fetches all distinct airport codes from both departure and arrival tables (not anymore)
     * Fetches all airport codes enabled for cross-check
     * Uses the is_cross_check_enabled flag instead of dynamic scanning
     * for better performance when dealing with many airports
     */
